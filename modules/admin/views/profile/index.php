        ...
        <div class="box box-primary">
            ...
            <div class="box-body">
                ...
                <p>Вы можете получать уведомления от нашего Facebook бота. Чтобы подключить бота - отправьте
                    ему данную команду : <code>ts-bind-<?= $model->bot_key; ?></code>. Стриницу бота вы
                    сможете найти по ссылке <a href="https://www.facebook.com/BotAdminizator-1254753901243704/">https://www.facebook.com/BotAdminizator-1254753901243704/</a>.
                    Вы также можете настроить ваши уведомления. После подключения отправьте боту команду <code>ts-get-all</code>, чтобы
                    получать уведомления о всех создаваемых тикетах. Чтобы получать уведомления только о тикетах которые назначены каким-то
                    конкретным пользователями введите команду <code>ts-get-ID_ПОЛЬЗОВАТЕЛЯ,ID_ПОЛЬЗОВАТЕЛЯ,...</code>. Чтобы узнать ваши текущие настройки - отправьте <code>ts-info</code>
                </p>
